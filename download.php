...
if ($show_form) {
    ...
    /*file_put_contents( "tmp/$base/{$table['list_page']}", $s->listtable() );
    file_put_contents( "tmp/$base/{$table['new_page']}", $s->newrow() );
    file_put_contents( "tmp/$base/{$table['edit_page']}", $s->editrow() );
    file_put_contents( "tmp/$base/{$table['delete_page']}", $s->deleterow() );
    */
