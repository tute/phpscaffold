...
It features basic HTTP or Session based authentication, paging and search
facility in list (index) page, and the generated forms responds to column
...
* Keep search criteria while paging.
