...
It features basic HTTP or Session based authentication, search facility in
list (index) page, and the generated forms responds to column types @text@,
@date@, @datetime@, @(var)char@ and @bool (int(1))@.
...
* Session based authentication, or no one.
